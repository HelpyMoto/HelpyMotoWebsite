  ...
  return (
    <div className='px-12 mb-12'>
        ...
        <div className='grid grid-cols-4 gap-8'>
            <div className='col-span-4 md:col-span-2 lg:col-span-1 border-[1px] border-gray-400 rounded-lg  border-solid'>
                <img src="service-1.jpg" alt="" className='w-full object-contain rounded-tr-lg rounded-tl-lg'/>
                <p className='font-semibold px-3 pt-3 text-lg'>Available anytime, anywhere</p>
            ...
            <div className='col-span-4 md:col-span-2 lg:col-span-1 border-[1px] border-gray-400 rounded-lg  border-solid'>
                ...
                <p className='font-semibold px-3 pt-3 text-lg'>Fair service cost</p>
            ...
            <div className='col-span-4 md:col-span-2 lg:col-span-1 border-[1px] border-gray-400 rounded-lg  border-solid'>
                ...
                <p className='font-semibold px-3 pt-3 text-lg'>Use quality spare parts</p>
            ...
            <div className='col-span-4 md:col-span-2 lg:col-span-1 border-[1px] border-gray-400 rounded-lg  border-solid'>
                ...
                <p className='font-semibold px-3 pt-3 text-lg'>Proven safety mechanism</p>
