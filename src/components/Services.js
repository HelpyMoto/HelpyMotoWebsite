...
const Services = () => {
  ...
  return (
    <div className='px-4'>
      ...
      >
        <p className='text-4xl md:text-5xl lg:text-6xl font-bold text-center mt-10 mb-2'>
          Our <span className='text-red-500'>Best</span> Services
        </p>
          ...
          return (
            <>
              <motion.div
                ...
                key={index}
                className='shadow-lg hover:scale-105 transition transform duration-200 ease-in-out w-[130px] md:w-[200px] lg:w-[200px] md:h-[200px] lg:h-[200px] h-[130px] md:w-[200px] lg:w-[200px] md:h-[200px] lg:h-[200px] rounded-md bg-gray-200 p-3 flex justify-center items-center flex-col cursor-pointer'
              >
